...
# reff: http://blog.amitsharma.in/2015/09/13/cumulative-distribution-plots-for-frequency-data-in-r/
...
cdf_plt <- ggplot(CDF_DAT, aes(DUR_MON, fill=SMELL)) + stat_ecdf(geom = "step") + facet_wrap(~ SMELL, , ncol=CDF_COL) + labs(x='Lifetime (Months)', y='CDF')
