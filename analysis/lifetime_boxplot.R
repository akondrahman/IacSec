...
# BOXPLOT_FILE <- "/Users/akond/Documents/AkondOneDrive/OneDrive/SecurityInIaC/output/plots_v4_new_old_moz/LIFETIME.csv"
# BOXPLOT_DATA <- read.csv(BOXPLOT_FILE)
# BOXPLOT_TITL <- "MOZILLA"
# BOXPLOT_LIMI <- c(0, 70)

# BOXPLOT_FILE <- "/Users/akond/Documents/AkondOneDrive/OneDrive/SecurityInIaC/output/plots_v4_new_old_ost/LIFETIME.csv"
# BOXPLOT_DATA <- read.csv(BOXPLOT_FILE)
# BOXPLOT_TITL <- "OPENSTACK"
# BOXPLOT_LIMI <- c(0, 75)

# BOXPLOT_FILE <- "/Users/akond/Documents/AkondOneDrive/OneDrive/SecurityInIaC/output/plots_v4_new_old_wik/LIFETIME.csv"
# BOXPLOT_DATA <- read.csv(BOXPLOT_FILE)
