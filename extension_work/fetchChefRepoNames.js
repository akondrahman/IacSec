// code to get Chef  repo names 
// need to run in msr19/source for dependencies 
const BigQuery = require('@google-cloud/bigquery');
var fs = require('fs');

const projectId = "githubsolidityquery";
const sqlQuery = 'SELECT * FROM `LOL.TSE_CHEF_GITHUB_REPOS`' ; 

var out_fil = 'TSE_GITHUB_CHEF_REPO_NAMES.csv'
...
bigquery
  ...
  .then(results => {
    ...
    if(err) {
        ...
        console.log("Chef Github repo names dumped succesfully ... ");
    }); 
